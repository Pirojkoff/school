    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php?action=main">School</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                           aria-expanded="false">Учителя <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="index.php?action=index-teacher">Список учителей</a></li>
                            <li role="separator" class="divider"></li>
                            <li><a href="index.php?action=delete-all-teacher">Удалить всех</a></li>
                        </ul>
                    </li>
                </ul>
